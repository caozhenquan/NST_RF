	...
	; Compiler options:
	;
	; -olt6601n_phonetxrx.cof -mlt6601n_phonetxrx.map --summary=default \
	; --output=default --codeoffset=00 main.p1 ble_iic.p1 lt8988drv.p1 \
	; 8988_ble.lpp --chip=16F685 -P --runtime=default --opt=default \
