	...
	; Compiler options:
	;
	; -olt6601_democode.cof -mlt6601_democode.map --summary=default \
	; --output=default --codeoffset=00 main.p1 lt89xxdrvspi.p1 spi_ble.p1 \
	; rx_ble.lpp --chip=16F685 -P --runtime=default --opt=default \
